  ...
  class _AdminLoginScreenState extends State<AdminLoginScreen> {
    ...
    // Function to login the admin using Employee ID and Password from approved_admin
    void _loginAdmin() async {
      String employeeId = _idController.text.trim(); // Treat Employee ID as a string
      ...
      try {
        ...
        QuerySnapshot adminQuery = await FirebaseFirestore.instance
            ...
            .where('employeeId', isEqualTo: employeeId) // Match as a string
            .get();
        ...
        if (adminQuery.docs.isNotEmpty) {
          ...
          if (storedPassword == password) {
            // Successful login - Navigate to Admin HomePage
