...
/* ─────────────────────────── WIDGETS ─────────────────────────── */
  Widget _buildHeaderCard() => Padding(
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.iron, size: 50, color: Color(0xFF170CFE)),
                  ...
                  child: IgnorePointer(
                    child: TextField(
                      ...
                      controller: TextEditingController(
                          text: '₱ ${pressPrice.toStringAsFixed(2)}'),
  ...
  Widget _buildCarefulNoteField() => Padding(
    padding: const EdgeInsets.symmetric(horizontal: 20),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
...
/* ─────────────────────────── CART ─────────────────────────── */
  Future<void> _handleAddToCart() async {
    ...
    final items = _gatherSelectedItems();
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => OrderingPage(
          ...
          typeOfLaundry: items,
          bulkyItems: const {},
          washBase: pressPrice,          // treat unit price as base
          priceOfBulkyItems: 0,
          totalPrice: pressPrice,
          personalRequest: noteController.text.trim(),
        ),
